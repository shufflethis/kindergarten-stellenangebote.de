  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Person',
        name: 'Thomas Sander',
        url: 'https://kindergarten-stellenangebote.de/autor/thomas-sander',
        jobTitle: 'Gründer & Geschäftsführer',
        worksFor: {
          '@type': 'Organization',
          name: 'Social Media Venture GmbH',
          url: 'https://kindergarten-stellenangebote.de',
        },
        description: 'HR-Tech-Experte und Gründer spezialisierter Jobportale für Fachkräfte in Deutschland.',
        knowsAbout: ['HR-Tech', 'Recruiting', 'Jobportale', 'Kindergarten', 'Personalwesen'],
            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist kindergarten-stellenangebote.de zu einer führenden Anlaufstelle für Kindergarten-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Kindergarten-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Kindergarten-Bereich' },
