  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (activeTab === 'employer') {
        ...
        formData.append('domain', 'kindergarten-stellenangebote.de');
        formData.append('niche', 'Kindergarten');
          ...
          {activeTab === 'employer' && (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input id="emp-stellentitel" name="stellentitel" required value={employer.stellentitel} onChange={handleEmployerChange} className={inputClass} placeholder="z.B. Kindergarten (m/w/d)" />
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input id="ini-gewuenschterBeruf" name="gewuenschterBeruf" required value={initiative.gewuenschterBeruf} onChange={handleInitiativeChange} className={inputClass} placeholder="z.B. Kindergarten" />
                    </div>
                  </div>
